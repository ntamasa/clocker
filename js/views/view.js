...
formCountry = document.querySelector(".form-box__country");
formCity = document.querySelector(".form-box__city");
formContinent = document.querySelector(".form-box__continent");

btn = document.querySelector(".form__btn");
btnIcon = document.querySelector(".form__icon");

formBackground = document.querySelector(".form__background");
formHeading = document.querySelector(".form-box__heading");
formContent = document.querySelector(".form-box__content");
formMap = document.querySelector(".form-box__map");
